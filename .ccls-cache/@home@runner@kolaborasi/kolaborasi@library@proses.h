    ...
    void cetak(){
      cout<<"Anda sebagai Proses \n";
		...
		void getData(){
			...
			ambil_data.close();
			cout << endl;
			cout << "Jumlah ayam geprek : " << bnyk_aymGP << endl;
			cout << "Jumlah ayam goreng : " << bnyk_aymGR << endl;
			cout << "Jumlah udang goreng : " << bnyk_udgGR << endl;
			cout << "Jumlah cumi goreng : " << bnyk_cmiGR << endl;
			cout << "Jumlah ayam bakar : " << bnyk_aymBK << endl;
			cout << "Jarak rumah : " << jarak;
